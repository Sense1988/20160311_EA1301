...
void btmtk_adp_system_power_on_req(void)
{
	...
	bt_prompt_trace(MOD_BT, "btmtk_adp_system_power_on_req step 0");
    BTAdpCoreCtx.notify_evm = 0;
	...
	bt_prompt_trace(MOD_BT, "btmtk_adp_system_power_on_req step 1");
    /* Adaptor and profile init */
    bt_profiles_init();
	bt_prompt_trace(MOD_BT, "btmtk_adp_system_power_on_req step 2");
    bt_adp_profiles_init();   
	bt_prompt_trace(MOD_BT, "btmtk_adp_system_power_on_req step 3");
    ...
    bt_prompt_trace(MOD_BT, "__BTMODULE_MT6622__ power on");
#elif defined(__BT_BTWIFI_COMBO_CHIP__)
    bt_prompt_trace(MOD_BT, "__BT_BTWIFI_COMBO_CHIP__ power on");
#elif defined(__BT_CSR_USB_CHIP__)
    bt_prompt_trace(MOD_BT, "__BT_CSR_USB_CHIP__ power on");
