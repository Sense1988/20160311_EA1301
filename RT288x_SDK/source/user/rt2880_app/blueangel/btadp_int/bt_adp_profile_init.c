...
bt_prompt_trace(MOD_BT, "bt_adp_profiles_init step 0");
...
bt_prompt_trace(MOD_BT, "bt_adp_profiles_init step 6");
...
bt_prompt_trace(MOD_BT, "bt_adp_profiles_init step 11");

#if defined(__BT_TIMEC_PROFILE__) || defined(__BT_TIMES_PROFILE__)
	time_adp_init();
#endif
bt_prompt_trace(MOD_BT, "bt_adp_profiles_init step 12");

#if defined(__BT_HDP_PROFILE__)
	hdp_adp_init();
#endif
bt_prompt_trace(MOD_BT, "bt_adp_profiles_init finish");
