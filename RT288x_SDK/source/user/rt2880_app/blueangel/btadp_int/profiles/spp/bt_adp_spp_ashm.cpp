...
void btmtk_adp_spp_start_ashm_service()
{
	...
	btmtk_ashm_start_service((const char*)SPP_GET_ASHM_NAME, SPP_GET_DATA_SHARED_BUFFER_SIZE);
	btmtk_ashm_start_service((const char*)SPP_PUT_ASHM_NAME, SPP_PUT_DATA_SHARED_BUFFER_SIZE);
