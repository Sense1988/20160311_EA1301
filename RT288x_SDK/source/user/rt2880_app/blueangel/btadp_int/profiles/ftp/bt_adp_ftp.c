...
extern void btmtk_adp_ftpc_start_ashm_service();
extern void* btmtk_adp_ftpc_get_ashm_buffer();
extern void btmtk_adp_ftps_start_ashm_service();
...
void ftps_adp_init() {
    btmtk_adp_ftps_start_ashm_service();
...
void ftpc_adp_init() {
    btmtk_adp_ftpc_start_ashm_service();
#ifdef __BT_GOEP_V2__
    ftpc_init();
#endif
}
