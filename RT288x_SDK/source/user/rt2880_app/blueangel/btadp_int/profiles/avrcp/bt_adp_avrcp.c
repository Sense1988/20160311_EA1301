...
void bt_avrcp_send_connect_cnf( module_type dst_mod_id, U8 chnl_num, U16 result, bt_avrcp_dev_addr_struct* device_addr, U8 connect_id, U16 tgFeature, U16 tgVersion)
{
	...
	msg_p->remote_tg_support_feature = tgFeature;
	msg_p->remote_tg_version = tgVersion;
    ...
    switch (Parms->event)
    {
        ...
        case BTAVRCP_EVENT_CONNECT_CNF:
            bt_avrcp_send_connect_cnf(
                ...
                Parms->p.AVRCPEventConnectCnf.remote_tg_support_feature,
                Parms->p.AVRCPEventConnectCnf.remote_tg_version);
            break;
        ...
        case BTAVRCP_EVENT_BROWSE_DISCONNECT_IND:
            ...
            break;
		case BTAVRCP_EVENT_BROWSE_DISCONNECT_CNF:
			bt_avrcp_send_command_ind(
				MOD_MMI,
				MSG_ID_BT_AVRCP_BROWSE_DISCONNECT_CNF,
				(U8 *) &Parms->p.AVRCPEventBrowseDisconnectCnf,
                sizeof(BTAVRCPEventBrowseDisconnectCnf));
			break;
    ...
    switch (ilm_ptr->msg_id)
    {
        ...
        case MSG_ID_BT_AVRCP_CONNECT_IND_RSP:
            AVRCP_UitlConnectIndRes(
            	  ...
            	  ((bt_avrcp_connect_ind_rsp_struct*) msg_p)->pending_conn);
            break;
