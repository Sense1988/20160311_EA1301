...
extern void BTA2DPAdpStreamOpenCfm(U16 result, U8 stream_handle, bt_addr_struct *device_addr, U8 *dev_name, U8 name_len, bt_a2dp_audio_cap_struct *config);
extern void BTA2DPAdpStreamOpenInd(U8 stream_handle, bt_addr_struct *device_addr, U8 *dev_name, U8 name_len, bt_a2dp_audio_cap_struct *config);
...
extern void BTA2DPAdpStreamDataInd(U8 stream_handle,U8 *buf,U16 buf_size);
extern void BTA2DPAdpStreamSetConfigCnf(U16 result, U8 stream_handle);

#ifdef __PRJ_MT7650_SONY_BDP__
extern void BTA2DPAdpSecondStreamInd(bt_addr_struct *first_device_addr, bt_addr_struct *second_device_addr);
extern void BTA2DPAdpAvdtpConnectedInd(bt_addr_struct * device_addr);
extern void BTA2DPAdpAvdtpDisconnectedInd(bt_addr_struct *device_addr);
#endif
    ...
    switch (Parms->event)
    {
        ...
        case BTA2DP_EVENT_STREAM_OPEN_CNF:
            BTA2DPAdpStreamOpenCfm(Parms->result, 
                ...
                &Parms->p.A2DPEventOpenStreamCnf.config);
            break;
        case BTA2DP_EVENT_STREAM_OPEN_IND:
            BTA2DPAdpStreamOpenInd(Parms->p.A2DPEventOpenStreamInd.stream_handle,
                ...
                &Parms->p.A2DPEventOpenStreamInd.config);
            break;
        ...
        case BTA2DP_EVENT_STREAM_DATA_CONFIG_CHANGE:
            ...
            break;
		case BTA2DP_EVENT_STREAM_DATA_IND:
#ifdef __PRINT_A2DP_DATA_LOG__ 		
	    	Report(("Remote device send media data to local  in a2dp_app_callback "));	
#endif
            BTA2DPAdpStreamDataInd(Parms->p.A2DPEventDataStreamInd.stream_handle,Parms->p.A2DPEventDataStreamInd.buf,Parms->p.A2DPEventDataStreamInd.buf_size);
            break;		
        case BTA2DP_EVENT_STREAM_DATA_CONFIG_CNF:
            //BTA2DPAdpStreamDataConfigCnf(Parms->p.A2DPEventStreamDataConfigCnf.audio_cap);
            break;
		case BTA2DP_EVENT_SET_CONFIGURATION_CNF:
			BTA2DPAdpStreamSetConfigCnf(Parms->result, Parms->p.A2DPEventSetConfigurationCnf.stream_handle);
			break;
#ifdef __PRJ_MT7650_SONY_BDP__
        case BTA2DP_EVENT_SECOND_STREAM_IND:
            BTA2DPAdpSecondStreamInd(Parms->p.A2DPEventSecondStreamInd.first_device_addr, Parms->p.A2DPEventSecondStreamInd.second_device_addr);
            break;
        case BTA2DP_EVENT_AVDTP_CONNECTED_IND:
            BTA2DPAdpAvdtpConnectedInd(Parms->p.A2DPEventAvdtpConnectedInd.device_addr);
            break;
        case BTA2DP_EVENT_AVDTP_DISCONNECTED_IND:
            BTA2DPAdpAvdtpDisconnectedInd(Parms->p.A2DPEventAvdtpDisconnectedInd.device_addr);
            break;
#endif
    }
}
