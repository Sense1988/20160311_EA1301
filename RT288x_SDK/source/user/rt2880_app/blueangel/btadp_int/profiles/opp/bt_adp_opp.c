...
extern void btmtk_adp_oppc_start_ashm_service();
extern void* btmtk_adp_oppc_get_ashm_buffer();
extern void btmtk_adp_opps_start_ashm_service();
...
void opps_adp_init(){
	...
	btmtk_adp_opps_start_ashm_service();
}

void oppc_adp_init(){

	btmtk_adp_oppc_start_ashm_service();
}
#endif
