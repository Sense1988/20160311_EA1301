...
#define BIP_ADP_ROOT_FOLDER     (L"/acfg/bluetooth/BlueAngel/")
#define BIP_ADP_WORK_FOLDER     (L"/acfg/bluetooth/BlueAngel/profile/")           //working folder
#define BIP_ADP_SND_FILE        (L"/acfg/bluetooth/BlueAngel/profile/bip_snd.tmp")     //for sending object
#define BIP_ADP_RCV_FILE        (L"/acfg/bluetooth/BlueAngel/profile/bip_rcv.tmp")     //for receiving object
#define BIP_ADP_IMG_LIST_FILE   (L"/acfg/bluetooth/BlueAngel/profile/bip_img_list.tmp")     //for image list
#define BIP_ADP_DESCPTR_FILE    (L"/acfg/bluetooth/BlueAngel/profile/bip_descptr.tmp")     //for descriptor xml file
#define BIP_ADP_PUSH_TMP_FILE   (L"/acfg/bluetooth/BlueAngel/profile/bip_push.tmp")     //for incoming push tmp file

#else
//mtk03036
#define BIP_ADP_ROOT_FOLDER     (L"/var/lib/bluetooth/BlueAngel/")
#define BIP_ADP_WORK_FOLDER     (L"/var/lib/bluetooth/BlueAngel/profile/")           //working folder
#define BIP_ADP_SND_FILE        (L"/var/lib/bluetooth/BlueAngel/profile/bip_snd.tmp")     //for sending object
#define BIP_ADP_RCV_FILE        (L"/var/lib/bluetooth/BlueAngel/profile/bip_rcv.tmp")     //for receiving object
#define BIP_ADP_IMG_LIST_FILE   (L"/var/lib/bluetooth/BlueAngel/profile/bip_img_list.tmp")     //for image list
#define BIP_ADP_DESCPTR_FILE    (L"/var/lib/bluetooth/BlueAngel/profile/bip_descptr.tmp")     //for descriptor xml file
#define BIP_ADP_PUSH_TMP_FILE   (L"/var/lib/bluetooth/BlueAngel/profile/bip_push.tmp")     //for incoming push tmp file
#endif
#elif WIN32
