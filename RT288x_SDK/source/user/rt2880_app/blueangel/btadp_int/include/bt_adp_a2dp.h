...
typedef struct _BTA2DPEventDataStreamInd {
    U8                      stream_handle;
    U8                      *buf;
    U16                     buf_size;
} BTA2DPEventDataStreamInd;

#ifdef __PRJ_MT7650_SONY_BDP__
typedef struct _BTA2DPEventSecondStreamInd {
    bt_addr_struct   *first_device_addr;
    bt_addr_struct   *second_device_addr;
} BTA2DPEventSecondStreamInd;

typedef struct _BTA2DPEventAvdtpConnectedInd {
    bt_addr_struct   *device_addr;
} BTA2DPEventAvdtpConnectedInd;

typedef struct _BTA2DPEventAvdtpDisconnectedInd {
    bt_addr_struct   *device_addr;
} BTA2DPEventAvdtpDisconnectedInd;
...
#define BTA2DP_EVENT_STREAM_DATA_IND                0x1E
#ifdef __PRJ_MT7650_SONY_BDP__
#define BTA2DP_EVENT_SECOND_STREAM_IND              0x1F
#define BTA2DP_EVENT_AVDTP_CONNECTED_IND            0x20
#define BTA2DP_EVENT_AVDTP_DISCONNECTED_IND         0x21
#endif
...
struct _BTA2DPCallbackParms {
    ...
    union {
		...
		BTA2DPEventDataStreamInd            A2DPEventDataStreamInd;
#ifdef __PRJ_MT7650_SONY_BDP__
        BTA2DPEventSecondStreamInd          A2DPEventSecondStreamInd;
        BTA2DPEventAvdtpConnectedInd        A2DPEventAvdtpConnectedInd;
        BTA2DPEventAvdtpDisconnectedInd     A2DPEventAvdtpDisconnectedInd;
#endif
    } p;
};
