...
#define BTBM_EVENT_WRITE_BONDABLE_MODE_RESULT               (0x20)
...
/* Project-dependent event ID start from 0x50 */
#if defined(__PRJ_MT7650_SONY_BDP__)
#define BTBM_EVENT_GET_PAIRED_DEVICE_INDICATION             (0x50)
#define BTBM_EVENT_GET_PAIRED_DEVICE_RESULT                 (0x51)
#define BTBM_EVENT_READ_PROPERTY_RESULT                     (0x52)
#define BTBM_EVENT_SET_SSP_MITM_RESULT                      (0x53)
#define BTBM_EVENT_SET_SSP_BONDING_RESULT                   (0x54)
#define BTBM_EVENT_SET_SSP_IO_CAPABILITY_RESULT             (0x55)
#endif
...
#if defined(__PRJ_MT7650_SONY_BDP__)
typedef struct _BMEventGetPairedDeviceIndication {
    U8                  index;
    btbm_bd_addr_t      bd_addr;
    char name[BTBM_ADP_MAX_NAME_LEN];
} BMEventGetPairedDeviceIndication;

typedef struct _BMEventGetPairedDeviceResult {
    U8                  result;
    U8                  no;
} BMEventGetPairedDeviceResult;
...
#if defined(__PRJ_MT7650_SONY_BDP__)
        BMEventGetPairedDeviceIndication        GetPairedDeviceIndication;
        BMEventGetPairedDeviceResult            GetPairedDeviceResult;
        BMEventReadPropertyResult               ReadPropertyResult;
#endif
    } p;
};
