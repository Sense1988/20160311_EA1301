...
#define BTAVRCP_EVENT_BROWSE_DISCONNECT_CNF         0x0c
...
typedef bt_avrcp_browse_disconnect_cnf_struct					BTAVRCPEventBrowseDisconnectCnf;
...
typedef struct _BTAVRCPCallbackParms {
    ...
    union{
		...
		BTAVRCPEventBrowseDisconnectCnf AVRCPEventBrowseDisconnectCnf;
