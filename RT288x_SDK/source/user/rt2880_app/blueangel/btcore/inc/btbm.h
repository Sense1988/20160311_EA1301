...
#define BM_ROLE_SWITCH_STOP_ENCRYPTION    (0x01)
#define BM_ROLE_SWITCH_ROLE_SWITCH            (0x02)
#define BM_ROLE_SWITCH_START_ENCRYPTION  (0x03)
...
{
    BOOL used;
    BTBMInquiredDeviceState istate;
    BD_ADDR remote_addr;
    BtDeviceContext *bdc;
#ifdef __BT_4_0_BLE__
    BtDevType devType;
    LeAddrType addrType;
    U8 queuedGattDevName[BTBM_ADP_MAX_NAME_LEN + 1];  /* discover result was sent later, so name need to be queued */
...
typedef struct _BMContent_T
{
    ...
    U8 loop_inquiry_length;
    U8 loop_inquiry_number;
...
//    EvmTimer dual_inquiry_timer;
//    BTBMReqDevice_struct_t gatt_req_device;
#endif
...
*   
*************************************************************************/
void BTBMDoRoleSwitch(BtRemoteDevice *link);
