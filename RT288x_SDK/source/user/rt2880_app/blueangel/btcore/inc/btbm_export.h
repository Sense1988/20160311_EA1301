...
/*************************************************************************
* FUNCTION                                                            
*  BTBMGapWriteBondable
* DESCRIPTION                                                           
*   This function is used to set the bondable mode setting.
*
* PARAMETERS
*  None
* RETURNS
...
* DESCRIPTION                                                           
*   This function is used to set SSP MITM mode
*
* PARAMETERS
*  bt_bm_set_ssp_mitm_req_struct
*       mode: SSP MITM mode, 1:MITM Required, 0:MITM Not Required
* RETURNS
*  None
* GLOBALS AFFECTED
*   
...
* DESCRIPTION                                                           
*   This function is used to set SSP Bonding mode
*
* PARAMETERS
*  bt_bm_set_ssp_bonding_req_struct
*       mode: SSP Bonding mode, 2:General Bonding, 1:Dedicated Bonding, 0:No Bonding
* RETURNS
*  None
* GLOBALS AFFECTED
*   
...
* DESCRIPTION                                                           
*   This function is used to set SSP IO Capability
*
* PARAMETERS
*  bt_bm_set_ssp_io_capability_req_struct
*  0: Display only
*  1: Display YesNo
*  2: KeyboardOnly
*  3: NoInputNoOutput
