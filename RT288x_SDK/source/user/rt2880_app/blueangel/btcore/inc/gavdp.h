...
#define MAX_NUM_REMOTE_CP 2
#else
#define MAX_NUM_REMOTE_SEIDS    6 // iPad mini has 6 caps.
#define MAX_NUM_REMOTE_CAPS     6  
#define MAX_NUM_REMOTE_CP       MAX_NUM_REMOTE_CAPS
#endif

//content protection	
#define MAX_NUM_LOCAL_CP 2
...
#define GAVDP_EVENT_CHANGE_PARAMETERS_CHANGED 0x13

#define GAVDP_EVENT_STREAM_SET_CONFIG_CNF 0x14

#ifdef __PRJ_MT7650_SONY_BDP__
#define GAVDP_EVENT_SECOND_CONNECTION_IND 0x15
#define GDVDP_EVENT_AVDTP_CONNECTED_IND 0x16
#define GDVDP_EVENT_AVDTP_DISCONNETED_IND 0x17
#endif

typedef U8 GavdpError;
#define GAVDP_ERR_NO_ERR 0x00
#ifdef __PRJ_MT7650_SONY_BDP__
#define GAVDP_ERR_BAD_STATE 0xf6
#define GAVDP_ERR_INVALID_CAPABILITY 0xf7
#endif
#define GAVDP_ERR_ALREADY_INIT 0xf8
...
#define GAVDP_CODEC_TYPE_AAC_MPEG2_AAC_LC       0x80
#define GAVDP_CODEC_TYPE_AAC_MPEG4_AAC_LC       0x40
#define GAVDP_CODEC_TYPE_AAC_MPEG4_AAC_LTP      0x20
#define GAVDP_CODEC_TYPE_AAC_MPEG2_AAC_SCALABLE 0x10
#define GAVDP_CODEC_TYPE_AAC_FREQ_8K            (1<<7)
#define GAVDP_CODEC_TYPE_AAC_FREQ_11K           (1<<6)
#define GAVDP_CODEC_TYPE_AAC_FREQ_12K           (1<<5)
#define GAVDP_CODEC_TYPE_AAC_FREQ_16K           (1<<4)
#define GAVDP_CODEC_TYPE_AAC_FREQ_22K           (1<<3)
#define GAVDP_CODEC_TYPE_AAC_FREQ_24K           (1<<2)
#define GAVDP_CODEC_TYPE_AAC_FREQ_32K           (1<<1)
#define GAVDP_CODEC_TYPE_AAC_FREQ_44K           (1<<0)
#define GAVDP_CODEC_TYPE_AAC_FREQ_48K           (1<<7)
#define GAVDP_CODEC_TYPE_AAC_FREQ_64K           (1<<6)
#define GAVDP_CODEC_TYPE_AAC_FREQ_88K           (1<<5)
#define GAVDP_CODEC_TYPE_AAC_FREQ_96K           (1<<4)
#define GAVDP_CODEC_TYPE_AAC_CH_MODE1           (1<<3)
#define GAVDP_CODEC_TYPE_AAC_CH_MODE2           (1<<2)
#define GAVDP_CODEC_TYPE_AAC_VBR                (1<<7)
...
struct _BtSepContext
{
  ...
  AvdtpStream stream;    
  AvdtpCodec codec;         // store the SEP setting set by upper layer.
  AvdtpContentProt content_protection[MAX_NUM_LOCAL_CP];  

  //only this two pointers are managed by GAVDP
  AvdtpChannel *signal_channel;
  CmgrHandler *cmgr_hdlr;
  EvmTimer sig_disc_timer;
  BOOL sig_disc_timer_is_active;
  

  BD_ADDR remote_bd_addr;
#ifdef __PRJ_MT7650_SONY_BDP__
  BD_ADDR second_conn_bd_sddr;
#endif
  ...
  AvdtpContentProt remote_cp_info[MAX_NUM_REMOTE_CP];
  U32 remote_cp_count;
  
  U32 current_cfg_sep_id;

  U16 prefer_size;
  AvdtpCodec current_cfg_codec; // current SEP setting set by AVDTP_SET_CFG.
  AvdtpCodec local_cfg_codec;   // store the temp SEP setting before AVDTP_SET_CFG done. (BlueAngel as AVDTP initiator)
  AvdtpCodec remote_cfg_codec;  // store the temp SET setting before AVDTP_SET_CFG done. (BlueAngel as AVDTP acceptor)

//content protection	
  AvdtpContentProt current_cfg_cp;
};
