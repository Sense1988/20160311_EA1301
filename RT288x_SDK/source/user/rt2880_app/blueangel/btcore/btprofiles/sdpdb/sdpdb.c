...
extern void BTAppHandleGetAvailableRecordHandler(void);
...
extern U8 HsphsSdpDB_GetAttribute(U16 service_type, SdpAttribute **attribute, U8 *srv_chn);
extern U8 HfphfSdpDB_GetAttribute(U16 service_type, SdpAttribute **attribute, U8 *srv_chn);
...
U8 SDPDB_GetLocalServiceAttribute(U16 service_type, SdpAttribute **attribute, U8 *srv_chn)
{
    ...
    else if (service_type == SC_HEADSET)
    {
        attribute_num = HsphsSdpDB_GetAttribute(SC_HEADSET, attribute, srv_chn);
    }
    else if (service_type == SC_HANDSFREE)
    {
        attribute_num = HfphfSdpDB_GetAttribute(SC_HANDSFREE, attribute, srv_chn);
    }
    else if (service_type == SC_AUDIO_SOURCE)
    {
    ...
    {
        attribute_num = AvrcpSdpDB_GetAttribute(SC_AV_REMOTE_CONTROL_TARGET, attribute);
    }
    else if (service_type == SC_AV_REMOTE_CONTROL)
    {
        attribute_num = AvrcpSdpDB_GetAttribute(SC_AV_REMOTE_CONTROL, attribute);
    }
