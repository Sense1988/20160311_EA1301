 ...
 *  void
 *****************************************************************************/
void BTAppHandleGetAvailableRecordHandler(void)
{
    U8 i = 0;
    U32 handle = 0;
    ...
    {
        BTAppHandleGetRecordHandleResult(BTSDPDBAPP_SDP_DDB_FULL, 0);
    }
    else
    {
        BTAppHandleGetRecordHandleResult(BTSDPDBAPP_SUCCESS, handle);
    }
}
 ...
 *  void
 *****************************************************************************/
void BTAppHandleGetRecordHandleResult(kal_uint8 result, kal_uint32 handle)
{
