 ...
 *  void
 *****************************************************************************/
void AvrcpHandleConnectCnf(U8 chnl_num, U16 result, bt_avrcp_dev_addr_struct *dev_addr, U8 connection_id, U16 browse_channel, U16 ctFeature,U16 tgFeature, U16 tgVersion)
{
    BTAVRCPCallbackParms parms;
	...
	parms.p.AVRCPEventConnectCnf.remote_tg_version = tgVersion;
 ...
 *  void
 *****************************************************************************/
void AvrcpHandleBrowseDisconnectCnf(U8 chnl_num, U16 reslult)
{
    BTAVRCPCallbackParms parms;

    parms.event = BTAVRCP_EVENT_BROWSE_DISCONNECT_CNF;
    parms.result = reslult;
    parms.p.AVRCPEventBrowseDisconnectCnf.chnl_num = chnl_num;
    avrcp_cntx[chnl_num].avrcpCBfunc(&parms);
    return;
}
 ...
 *  void
 *****************************************************************************/
void AvrcpHandleCommandFrameInd(U8 chnl_num, U16 result, U8 seq_id, U8 profile_id, U8 c_type, U8 subunit_type, U8 subunit_id, U16 data_len, U8 *frame_data)
{
    BTAVRCPCallbackParms parms;
...
void AvrcpHandleCBAVRCPCmdInd_Common(AvrcpChnlInfo *chnl_info, U16 result, U8 event_id, U16 data_len, U8 *data){
    ...
    if( data_len > sizeof(parms.p) ){
        Assert(0);
        return; // klocwork warnin
    }
        
    OS_MemCopy( (U8 *)&parms.p, data, data_len);
