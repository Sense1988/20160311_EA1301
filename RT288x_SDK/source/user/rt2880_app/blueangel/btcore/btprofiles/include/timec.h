...
#define TIME_CLIENT_LINK_CONNECT		1
#define TIME_CLIENT_QUERY				2
#define TIME_CLIENT_CONNECTING		3
#define TIME_CLIENT_CONNECTED			4
#define TIME_CLIENT_GETCAP				5
#define TIME_CLIENT_DISCONNECTING		6
...
void timec_notify_read_remote_value_result(TimeCContext *cntx, U32 rspcode, U8 value_id);
void timec_notify_write_remote_value_result(TimeCContext *cntx, U32 rspcode, U8 value_id);
