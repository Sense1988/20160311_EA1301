...
extern U8 BtbmAttHandlePrivacy(U8 type, BtRemoteDevice *link, U16 *len, U8 **raw);
extern U8 BtbmAttHandleReconnectAddress(U8 type, BtRemoteDevice *link, U16 *len, U8 **raw);
#endif
extern U8 BtbmAttHandleDeviceName(U8 type, BtRemoteDevice *link, U16 *len, U8 **raw);
extern U8 BtbmAttHandleAppearance(U8 type, BtRemoteDevice *link, U16 *len, U8 **raw);
