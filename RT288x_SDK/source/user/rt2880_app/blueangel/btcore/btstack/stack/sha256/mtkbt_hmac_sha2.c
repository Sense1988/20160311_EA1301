...
void LM_SspEng_sha2_process(sha2_context *ctx, u_int8 *data/*[64]*/)
{
...
static void LM_SspEng_sha2_update(sha2_context *ctx, u_int8 *input, u_int len)
{
	u_intL left, fill;
...
void LM_SspEng_sha2_hmac(u_int8 *buf, u_int buflen, u_int8 *key, u_int keylen, u_int8 *digest)
