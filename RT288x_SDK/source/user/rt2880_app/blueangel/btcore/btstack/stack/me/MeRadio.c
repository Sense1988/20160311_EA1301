...
//                extern const U8 wifi_channel_table[7][10];
            	...
            	{
            	    if ( wifiCh_table_index == 0 )  //klocwork
...
void MeHandleWritePCMSetValue(BtOpEvent event)
{
    switch (event)
    {
        case BOE_START:
            ...
            MeSendHciCommand(HCC_DUAL_PCM_SET_VALUE, MEC(dualPCMSetValue_len));
            return;
        case BOE_TASK_END:
        case BOE_TASK_ERR:
...
void MeHandleWritePCMSwitchValue(BtOpEvent event)
{
    switch (event)
    {
        case BOE_START:
            ...
            MeSendHciCommand(HCC_DUAL_PCM_SWITCH, MEC(dualPCMSwitchValue_len));
            return;
        case BOE_TASK_END:
        case BOE_TASK_ERR:
