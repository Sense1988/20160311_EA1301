...
void BTBMDoRoleSwitch(BtRemoteDevice *link)
{
    ...
    Report(("BTBMDoRoleSwitch: encryptState=0x%x, remoteFeature[5]=0x%x", link->encryptState, link->remoteFeature[5]));
    ...
    else
    {
        ...
        SEC_SetLinkEncryption(0, link, BECM_ENCRYPT_DISABLE);
    }
}
 ...
 *  void
 *****************************************************************************/
U8 BtbmAllocateFreeDevices(BD_ADDR bdAddr)
{
