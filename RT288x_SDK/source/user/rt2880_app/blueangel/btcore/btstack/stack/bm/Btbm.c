 ...
 *
 * Dec 18 2006 mtk01239
 * [MAUI_00348589] Bluetooth-Connect the BT device "Samsung Stereo Headset" and play audio, it will not
 * 
 *
 ...
 *
 * Aug 7 2006 mtk01239
 * [MAUI_00215286] [BT] Can't disconnect Moto HF800 HF profile.
 * 
 *
 * Aug 7 2006 mtk01239
 * [MAUI_00215286] [BT] Can't disconnect Moto HF800 HF profile.
 ...
 * [MAUI_00211879] [Bluetooth][ESI]update Bluetooth codes for IOT with MOTO HS820
 * 
 *
...
void Me2BMCallback(const BtEvent *Event)
{
    ...
    switch (Event->eType)
    {
        ...
        case BTEVENT_INQUIRY_COMPLETE:
            ...
            break;
#ifdef __BT_4_0_BLE__
        case BTEVENT_LE_INQUIRY_CANCELED:
#endif
