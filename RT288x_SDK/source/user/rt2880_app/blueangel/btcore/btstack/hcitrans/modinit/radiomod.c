...
#include <sys/types.h>
#include <sys/stat.h>
#if !defined(__BT_TRANSPORT_DRV__) && !defined(__BT_USE_KERNEL_DRIVER__)
...
static U8             radioState;     /* Current state of initialization or
                                       * shutdown.
                                       */
#if defined(BTMTK_ON_LINUX) && !defined(__BT_TRANSPORT_DRV__) && !defined(__BT_USE_KERNEL_DRIVER__)
...
BtStatus RADIO_Init(RadioCallback Callback)
{
    ...
    switch(getRadioType())
    {
#if defined (__BTMODULE_MT6601__) || defined (__BTMODULE_MT6611__) || defined (__BTMODULE_MT6612__) || defined (__BTMODULE_MT6616__) || defined (__BTMODULE_MT6622__) || defined (__BTMODULE_MT6236__) || defined (__BTMODULE_MT6255__) || defined (__BTMODULE_MT6276__) || defined (__BT_BTWIFI_COMBO_CHIP__) 
...
void RADIO_EventHandler_Default(U8 Event, HciCallbackParms *Parms)
{
    ...
    if ( (Event == HCI_CONTROLLER_EVENT) &&
        #if defined(BTMTK_ON_LINUX)
#ifdef __BT_USE_KERNEL_DRIVER__
