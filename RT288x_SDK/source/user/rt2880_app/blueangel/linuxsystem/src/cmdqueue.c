...
unsigned long checkResponseId(unsigned long req_id)
{
    ...
    */
    ...
    case MSG_ID_BT_HF_ACTIVATE_REQ:
        resp = MSG_ID_BT_HF_ACTIVATE_CNF;
        break;
    case MSG_ID_BT_HF_DEACTIVATE_REQ:
        resp = MSG_ID_BT_HF_DEACTIVATE_CNF;
        break;
    case MSG_ID_BT_HF_CONNECT_REQ:
        resp = MSG_ID_BT_HF_CONNECT_CNF;
        break;
    case MSG_ID_BT_HF_DISCONNECT_REQ:
        resp = MSG_ID_BT_HF_DISCONNECT_CNF;
        break;
    case MSG_ID_BT_HF_SCO_CONNECT_REQ:
        resp = MSG_ID_BT_HF_SCO_CONNECT_CNF;
        break;
    case MSG_ID_BT_HF_SCO_DISCONNECT_REQ:
        resp = MSG_ID_BT_HF_SCO_DISCONNECT_CNF;
        break;
    case MSG_ID_BT_HF_ACCEPT_CHANNEL_REQ:
        resp = MSG_ID_BT_HF_ACCEPT_CHANNEL_CNF;
        break;
    case MSG_ID_BT_HF_REJECT_CHANNEL_REQ:
        resp = MSG_ID_BT_HF_REJECT_CHANNEL_CNF;
        break;     
    ...
    case MSG_ID_BT_HFG_CONNECT_REQ:
        resp = MSG_ID_BT_HFG_CONNECT_CNF;
        break;
    case MSG_ID_BT_HFG_DISCONNECT_REQ:
        resp = MSG_ID_BT_HFG_DISCONNECT_CNF;
        break;
    case MSG_ID_BT_HFG_SCO_CONNECT_REQ:
        resp = MSG_ID_BT_HFG_SCO_CONNECT_CNF;
        break;
    case MSG_ID_BT_HFG_SCO_DISCONNECT_REQ:
        resp = MSG_ID_BT_HFG_SCO_DISCONNECT_CNF;
        break;
