 ...
 * Description:
 * ------------
 * This file is used to define message for HF
 *
 *============================================================================
 *             HISTORY
 ...
 *============================================================================
 ****************************************************************************/
#ifndef __BLUETOOTH_HF_MESSAGE_H__
#define __BLUETOOTH_HF_MESSAGE_H__
...
typedef enum 
{
...
#else
    MSG_ID_BT_HF_ACTIVATE_REQ = MSG_ID_BT_HF_GROUP_START,
#endif /* BTMTK_ON_WISE */  
    ...
    MSG_ID_BT_HF_GROUP_END = MSG_ID_BT_HF_DATA_IND,
#ifdef SOURCE_INSIGHT_TRACE
}hf_msg_type_enum;
#endif
	
#endif /* __BLUETOOTH_HF_MESSAGE_H__ */
