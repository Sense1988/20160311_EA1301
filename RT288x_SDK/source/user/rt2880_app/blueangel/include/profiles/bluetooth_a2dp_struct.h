...
#define MAX_NUM_REMOTE_STREAM_ENDPOINT_IDS        (4)  /* MAX_NUM_REMOTE_SEIDS already defined in gavdp.h */
...
#undef MAX_A2DP_SEP_NUM
#define MAX_A2DP_SEP_NUM            3
#endif
...
typedef struct
{
	U8 codec_type; // SBC, AAC
	U8 sep_type;   // BT_A2DP_SOURCE, BT_A2DP_SINK
...
{
	LOCAL_PARA_HDR
	U8 default_local_role;    //BT_A2DP_SOURCE(0)   BT_A2DP_SINK(1)
	U8 sep_num;
...
} bt_a2dp_second_stream_ind_struct;

typedef struct
{
    LOCAL_PARA_HDR
    bt_addr_struct device_addr;
} bt_a2dp_avdtp_connected_ind_struct;

typedef struct
{
    LOCAL_PARA_HDR
    bt_addr_struct device_addr;
} bt_a2dp_avdtp_disconnected_ind_struct;

typedef struct
{
	LOCAL_PARA_HDR
	U8 default_local_role;
} bt_a2dp_set_local_role_req_struct;
...
typedef struct
{
	...
	U16 result;
	U8 sep_num;
	bt_sep_info_struct sep_list[MAX_NUM_REMOTE_STREAM_ENDPOINT_IDS];
...
typedef struct
{
	...
	U8 buf[1015];
	#endif
} bt_a2dp_stream_data_ind_struct;
...
typedef struct
{
	LOCAL_PARA_HDR
	U8 stream_handle;
}bt_a2dp_stream_channel_open_req_struct;
...
#ifdef __PRJ_MT7650_SONY_BDP__
    BT_A2DP_RESULT_BAD_SEP,
    BT_A2DP_RESULT_INVALID_CAPABILITY,
    BT_A2DP_RESULT_NO_RESOURCE,
    BT_A2DP_RESULT_SAME_DEV,
    BT_A2DP_RESULT_CONN_IN,
#endif
