...
typedef enum 
{
    ...
    MSG_ID_BT_BM_WRITE_BONDABLE_MODE_REQ,
    ...
    MSG_ID_BT_BM_GET_PAIRED_DEVICE_REQ,
    MSG_ID_BT_READ_RSSI_REQ,
    MSG_ID_BT_BM_WRITE_SSP_MITM_MODE_REQ,
    MSG_ID_BT_BM_WRITE_SSP_BONDING_MODE_REQ,
    MSG_ID_BT_BM_SET_SSP_IO_CAPABILITY_REQ,
    MSG_ID_BT_BM_SET_VIRTUAL_SNIFFER_REQ,
    MSG_ID_BT_BM_SET_TERMINAL_LOG_REQ,
    ...
    MSG_ID_BT_BM_GET_PAIRED_DEVICE_CNF,         //199
    ...
    MSG_ID_BT_GAP_GROUP_END = MSG_ID_BT_BM_WRITE_SSP_IO_CAPABILITIES_CNF,
