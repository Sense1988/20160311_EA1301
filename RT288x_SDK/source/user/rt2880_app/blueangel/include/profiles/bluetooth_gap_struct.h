...
#elif defined(__PRJ_MT7650_SONY_BDP__)
#define BTBM_ADP_MAX_NAME_LEN (255)
#else
...
#define BTBM_ADP_MAX_INQUIRY_NO (32)
#else
...
typedef struct
{
    ...
    kal_uint8 index;
    kal_uint8 no;
} bt_bm_get_paired_device_req_struct;
...
typedef struct
{
    ...
    kal_uint16 msg_len;
    kal_uint8 enable;
}bt_bm_set_virtual_sniffer_req_struct;
...
typedef struct
{
    ...
    kal_uint16 msg_len;
    kal_uint8 enable;
}bt_bm_set_terminal_log_req_struct;
#endif
...
} bt_bm_get_paired_device_ind_struct;
...
typedef struct
{
    LOCAL_PARA_HDR 
    kal_bool bondable;
} bt_bm_write_bondable_mode_req_struct;

typedef struct
{
    LOCAL_PARA_HDR 
    kal_uint8 result;
} bt_bm_write_bondable_mode_cnf_struct;
...
typedef struct {
	...
	kal_bool powered;
	kal_bool discoverable;
	kal_bool connectable;
	kal_bool pairable;
	kal_uint32 disctimeout;
	kal_uint32 pairtimeout;
	kal_bool discovering;
	char name[BTBM_ADP_MAX_NAME_LEN]; /* Name of device */
} bt_bm_read_property_cnf_struct;

typedef struct {
    LOCAL_PARA_HDR 
    kal_uint8 result;
} bt_bm_set_ssp_mitm_cnf_struct;

typedef struct {
    LOCAL_PARA_HDR 
    kal_uint8 result;
} bt_bm_set_ssp_bonding_cnf_struct;
typedef struct {
    LOCAL_PARA_HDR 
    kal_uint8 result;
} bt_bm_set_ssp_io_capabilities_cnf_struct;
#else
typedef struct
{
    LOCAL_PARA_HDR 
