...
typedef enum
{
    ...
    /* HF */
    MSG_ID_BT_HF_GROUP_START = (MSG_ID_BT_GOEPS_GROUP_START + MSG_ID_BT_GOEPS_GROUP_RANGE),
    MSG_ID_BT_HF_GROUP_RANGE = 100,    

    /* HFG */
    MSG_ID_BT_HFG_GROUP_START = (MSG_ID_BT_HF_GROUP_START + MSG_ID_BT_HF_GROUP_RANGE),
    MSG_ID_BT_HFG_GROUP_RANGE = 300,

	/* HFP */
    MSG_ID_BT_HFP_GROUP_START = (MSG_ID_BT_HFG_GROUP_START + MSG_ID_BT_HFG_GROUP_RANGE),
    MSG_ID_BT_HFP_GROUP_RANGE = 100,

    /* HID */
    MSG_ID_BT_HID_GROUP_START = (MSG_ID_BT_HFP_GROUP_START + MSG_ID_BT_HFP_GROUP_RANGE),
    ...
    MSG_ID_BT_SPP_GROUP_RANGE = 200, //100,
