...
#define INTERNAL_PHY_SLEW_RATE_LEVEL 5
...
#if IS_MT8580
#define CPU_MULTI_CORE
#endif


#ifdef CPU_MULTI_CORE
#define star_mb()   mb()
#else
#define star_mb() 
#endif
...
#define SIOC_SET_SPEED_CMD   (SIOCDEVPRIVATE+9)//see ioctl_mdio_cmd
...
#define SIOC_GLINKSTATE_CMD   (SIOCDEVPRIVATE+0)
...
void vStarControlLED(StarDev *dev , bool bEnable);
...
#define RX_RESUME				((u32)0x01 << 2)
#define RX_STOP  				((u32)0x01 << 1)
#define RX_START  				((u32)0x01 << 0)
