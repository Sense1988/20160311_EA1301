...
static const struct excel_info PartInfo_Private[PART_NUM]={			{"preloader",262144,0, EMMC, 0,EMMC_PART_BOOT1},
			...
			{"android",1073741824,0x5180000, EMMC, 5,EMMC_PART_USER},
			{"cache",132120576,0x45180000, EMMC, 6,EMMC_PART_USER},
			{"usrdata",2147483648,0x4cf80000, EMMC, 7,EMMC_PART_USER},
			{"fat",0,0xccf80000, EMMC, 8,EMMC_PART_USER},
